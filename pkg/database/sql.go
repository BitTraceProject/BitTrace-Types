...
CREATE TABLE IF NOT EXISTS %s (
  ...
  hash_str varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  height int NOT NULL,
...
CREATE TABLE IF NOT EXISTS %s (
  ...
  PRIMARY KEY(snapshot_id,revision_type)
...
func SqlInsertSnapshotData(tableName string, snapshotData ...TableSnapshotData) string {
	...
	fields := "snapshot_id,target_chain_id,target_chain_height,init_timestamp,final_timestamp"
...
func SqlInsertState(tableName string, state ...TableState) string {
	...
	fields := "snapshot_id,snapshot_type,hash_str,height,bits,block_size,block_weight,num_txns,total_txns,median_timestamp"
